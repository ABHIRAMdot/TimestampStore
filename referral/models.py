...
class ReferralReward(models.Model):
    ...
    referrer = models.ForeignKey(
        ...
        on_delete=models.CASCADE, related_name='referral_reward_given',
        help_text= " user who referred someone")                       # User who referred

    referred_user = models.ForeignKey(
        'accounts.Account', 
        on_delete=models.CASCADE, related_name='referred_by_reward', 
        help_text="User who was referred")                              # User who was referred

    reward_amount = models.DecimalField(max_digits=10, decimal_places=2, default=500.00,
