...
class AddressForm(forms.ModelForm):
    ...
    class Meta:
        model = Address
        fields = ['full_name', 'mobile', 'second_mobile', 'street_address', 
        ...
        widgets = {
            ...
            'second_mobile': forms.TextInput(attrs={
                'class': 'form-control',
    ...
    def clean_second_mobile(self):
        ...
        if second_mobile:
            ...
            if primary_mobile and second_mobile == primary_mobile:
                raise forms.ValidationError("Alternate mobile cannot be same as primary mobile.")
