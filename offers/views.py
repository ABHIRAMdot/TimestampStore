...
def category_offer_list(request):
    ...
    offers = CategoryOffer.objects.all().select_related('category').order_by('-created_at')
    ...
    breadcrumbs = [
        {'label':'Back', 'url': reverse('offer_dashboard')}
    ]
...
def add_category_offer(request):
    ...
    breadcrumbs = [
        {'label':'Back', 'url': reverse('category_offer_list')}
    ]    
...
def product_offer_list(request):
    ...
    offers = ProductOffer.objects.all().select_related('product').order_by('-created_at')
...
def add_product_offer(request):
    ...
    if request.method == 'POST':
        ...
        if not all([name, product_id, discount, start_date, end_date]):
            messages.error(request, 'All required fields must be filled.')
            return render(request, 'offers/add_product_offre.html', {'products': products})
        ...
        try:
            ...
            return render(request, 'offers/add_product_offer.html', {'products': products})
    ...
    breadcrumbs = [
        {'label':'Back', 'url': reverse('product_offer_list')}
    ]
...
def edit_product_offer(request, offer_id):
    ...
    if request.method == 'POST':
        ...
        if not all([name, product_id, discount, start_date, end_date]):
            messages.error(request, 'All required fields must be filled.')
            return render(request, 'offers/edit_product_offer.html', {'offer': offer, 'products': products})
