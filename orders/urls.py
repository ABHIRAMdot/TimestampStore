...
urlpatterns = [
    ...
    path('my-orders/<str:order_id>/', views.user_order_detail, name='user_order_detail'),
    ...
    path('my-orders/item/<int:item_id>/return/', views.return_order_item_view, name='return_order_item'),
    path('my-orders/<str:order_id>/invoice/', views.download_invoice, name='download_invoice'),
